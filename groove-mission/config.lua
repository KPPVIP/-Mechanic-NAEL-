...
Config.LimitToGrooveJob = false
Config.GrooveModel = 'slamvan'
...
Config.Formulas = {
    ...
    additionalTimeForPickup     = function(distanceFromGroove)    return math.floor(distanceFromGroove / 15) end,
...
Config.MaxSpawnPointDistanceAllowedFromGroove = 1300 -- used to check that you didn't forget a - in a coordinate below or accidentally enter a paleto spawn location in for metro los santos :|

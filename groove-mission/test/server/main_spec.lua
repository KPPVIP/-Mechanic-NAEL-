...
describe('server - main', function()
    ...
    it('verify finish level events registered', function()
        verify(_G.Wrapper.RegisterNetEvent('blarglegroove:finishLevel'))
        verify(_G.Wrapper.AddEventHandler('blarglegroove:finishLevel', any()))
    end)
    ...
    it('finishLevel called -- finds player based on source and awards level-appropriate amount of money', function()
        ...
        getFunctionFromNativeCall('AddEventHandler', 'blarglegroove:finishLevel')(5)

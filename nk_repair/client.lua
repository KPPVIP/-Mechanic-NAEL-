...
AddEventHandler('nk_repair:MenuRipara', function()
	...
	if DoesEntityExist(veh) then
		if IsEntityAVehicle(veh) then
			local elements = {
				{ label = '🔧 Commencer la réparation', value = 'engb' }
			}
			...
			ESX.ShowNotification('Vous devez être près d\'un ~y~Véhicule~s~!') -- TRANSLATE THIS - THAT SAY WHEN YOU DON'T HAVE ANY VEHICLE IN THE NEAR
		end
	end
end)
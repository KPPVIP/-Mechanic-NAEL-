...
Config.Locale            = 'en'
Config.IsgrooveJobOnly = true

Config.Zones = {

	ls1 = {
		Pos   = { x = -93.05, y = -1795.81, z = 26.81},
	...
	ls4 = {
		Pos   = { x = -128.89, y = -1790.85, z = 24.131},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modArmor = {
		...
		parent = 'upgrades',
		modType = 16,
		price = {1500, 3000, 4500, 10000, 20000, 100000}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
